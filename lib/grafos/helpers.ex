defmodule Grafos.Helpers do

  @moduledoc """
    require Grafos.Helpers, as: H  # the cool way
  """
  @doc """
    ...
    ```
      config :grafos, app: :myapp
    ```

    Then you can use it as `H.env(:key)` instead of `H.env(:myapp, :key)`
  """
  def env(key, default \\ nil), do: env(Application.get_env(:grafos, :app, :grafos), key, default)
  def env(app, key, default), do: Application.get_env(app, key, default)

  @doc """
    Opposite of Grafos.Helpers.env.
  """
  def put_env(key, default \\ nil), do: put_env(Application.get_env(:grafos, :app, :grafos), key, default)
  ...
  defmacro spit(obj \\ "", opts \\ []) do
    quote do
      ...
      Grafos.Helpers.maybe_spit(obj, opts, opts[:sample])
      obj  # chainable
    end
  end
  ...
  @doc """
    ...
    Instead of:
      ...
      iex> [a: 3] |> Grafos.Helpers.defaults(a: 4, b: 5)
      [b: 5, a: 3]
      iex> %{a: 3} |> Grafos.Helpers.defaults(%{a: 4, b: 5})
      %{a: 3, b: 5}
